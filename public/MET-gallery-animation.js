...
export default function Model(props) {
  const group = useRef()
  const { nodes, materials, animations } = useGLTF('/MET-gallery-animation.glb')
  const { actions } = useAnimations(animations, group)
  return (
    <group ref={group} {...props} dispose={null}>
      <group name="Camera001" position={[-1.85, 1.88, 3.41]} rotation={[Math.PI / 2, 0, 1.6]}>
        <PerspectiveCamera makeDefault={false} far={1000} near={0.1} fov={22.1} rotation={[-Math.PI / 2, 0, 0]} />
      </group>
      <mesh
...
useGLTF.preload('/MET-gallery-animation.glb')
